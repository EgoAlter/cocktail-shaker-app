...
export const Engine = {
  ...
  // --- State render stubs ---
  _renderWelcome()     { Renderer.drawPlaceholder(this.ctx, this.canvas, 'WELCOME'); },
  _renderQuestioning() { Renderer.drawPlaceholder(this.ctx, this.canvas, 'QUESTIONING'); },
  _renderResult()      { Renderer.drawPlaceholder(this.ctx, this.canvas, 'RESULT'); },
  _renderFilling()     { Renderer.drawPlaceholder(this.ctx, this.canvas, 'FILLING'); },
  _renderSealed()      { Renderer.drawPlaceholder(this.ctx, this.canvas, 'SEALED'); },
  _renderShaking()     { Renderer.drawPlaceholder(this.ctx, this.canvas, 'SHAKING'); },
  _renderStill()       { Renderer.drawPlaceholder(this.ctx, this.canvas, 'STILL'); },
  _renderPouring()     { Renderer.drawPlaceholder(this.ctx, this.canvas, 'POURING'); },
  _renderDone()        { Renderer.drawPlaceholder(this.ctx, this.canvas, 'DONE'); },
};
